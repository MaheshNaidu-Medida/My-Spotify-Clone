...
class SpecificCategoryPlaylists extends Component {
  state = {
    fetchedData: {},
  ...
  renderSpecificCategoryDesktopItem = eachItem => {
    ...
    return (
      <Link
        to={`/category-playlists/category/${cid}/playlist/${id}`}
    ...
    return (
      <>
        ...
        <div className="specific-category-playlist-main">
          <Link to="/" className="specific-category-playlist-back-button">
  ...
  renderSpecificCategoryPlaylistMobile = () => {
    ...
    return (
      <div className="specific-category-playlist-main-mobile">
        <Link to="/" className="specific-category-playlist-back-btn-mobile">
...
export default SpecificCategoryPlaylists
